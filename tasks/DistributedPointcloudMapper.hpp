...
namespace slam3d {
    ...
    /*! \class DistributedPointcloudMapper 
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','slam3d::DistributedPointcloudMapper')
     end
     \endverbatim
    ...
    public:
        /** TaskContext constructor for DistributedPointcloudMapper
        ...
        /** Default deconstructor of DistributedPointcloudMapper
         */
